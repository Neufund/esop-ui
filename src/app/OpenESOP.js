...
export default class Init extends React.Component {
  ...
  handleOpenEsopButton = () => {
    ...
    const handleError = function (that, error) {
      that.store.dispatch({
        type: 'SHOW_CONFIRM_TRANSACTION_DIALOG',
    ...
    return (
      ...
      <div className="new_esop">
        ...
        {userState.userType !== 'ceo' ?
          <div className="row">
            <div className="col-xs-12 col-md-10 col-md-offset-1">
              <h3>To set the terms & conditions of ESOP please connect company manages's
                account {ESOPState.companyAddress} configured during deployment process</h3>
            </div>
          </div>
          :
          <div className="contract_parameters">
            ...
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-5 col-md-offset-1 col-lg-4">
                ...
                <IconButton tooltip={Texting.definitions.totalPoolOptions} iconClassName="material-icons"
              ...
              <div className="col-xs-12 col-sm-6 col-md-5 col-lg-4">
                ...
                <IconButton tooltip={Texting.definitions.cliffPeriod} iconClassName="material-icons"
                            tooltipStyles={tooltipStyles}>info_outline</IconButton>
              </div>
            </div>
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-5 col-md-offset-1 col-lg-4">
                ...
                <IconButton tooltip={Texting.definitions.vestingPeriod} iconClassName="material-icons"
                            tooltipStyles={tooltipStyles}>info_outline</IconButton>
              </div>
              <div className="col-xs-12 col-sm-6 col-md-5 col-lg-4">
                <TextField {...textFieldsProps.residualAmountProps} />
                <IconButton tooltip={Texting.definitions.residualAmount} iconClassName="material-icons"
                            tooltipStyles={tooltipStyles}>info_outline</IconButton>
              </div>
            </div>
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-5 col-md-offset-1 col-lg-4">
                ...
                <IconButton tooltip={Texting.definitions.bonusOptions} iconClassName="material-icons"
                            tooltipStyles={tooltipStyles}>info_outline</IconButton>
              </div>
              <div className="col-xs-12 col-sm-6 col-md-5 col-lg-4">
                <TextField {...textFieldsProps.newEmployeePoolProps} />
                <IconButton tooltip={Texting.definitions.newEmployeePool} iconClassName="material-icons"
                            tooltipStyles={tooltipStyles}>info_outline</IconButton>
              </div>
            </div>
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-5 col-md-offset-1 col-lg-4">
                ...
                <IconButton tooltip={Texting.definitions.optionsPerShare} iconClassName="material-icons"
                            tooltipStyles={tooltipStyles}>info_outline</IconButton>
              </div>
            </div>
            <div className="row">
              <div className="col-xs-12 col-md-10 col-md-offset-1">
                ...
                <IconButton tooltip={Texting.definitions.termsDocIPFSHash} iconClassName="material-icons"
                            tooltipStyles={tooltipStyles}>info_outline</IconButton>
                <RaisedButton
            ...
            <div className="row">
              <div className="col-xs-12 col-md-10 col-md-offset-1">
                <br/>
                <a href="https://github.com/Neufund/ESOP#esop-algorithm" target="_new">Read more on configuring ESOP
                  Terms & Conditions</a>
              </div>
            </div>
            <div className="row">
