        ...
        <table>
          ...
          <tbody>
            {employees.map((employee, index) =>
              (<tr
                key={index}
                onTouchTap={handleRowClick(employee.address)}
              ...
              >
                ...
                <td>
                  {ContractUtils.getEmployeeStateName(employee.state, employee.suspendedAt,
                    employee.timeToSign <= currentBlockTimestamp)}
                </td>
              </tr>)
            )}
          </tbody>
