      ...
      <div className="row">
        <div className="col-xs-12 employee_add">
          ...
          <div id="add_employee_form">
            ...
            <a className="etherscan_link" target="_blank"
               href={ContractUtils.formatEtherscanUrl(this.state.employeePublicKey, ESOPState.networkId)}>
            ...
            <Checkbox
              label="issue extra options instead of pool options"
              checked={this.state.extraOptions}
