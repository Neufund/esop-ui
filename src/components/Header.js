            ...
            <div className="introduction">
                <div className="row center-md greeting">
                    <div className="text col-xs-12 col-md-5">
                        ...
                        <p>Neufund’s mission is to establish an active secondary market for startup equity, through providing a solution to represent startup shares as Blockchain tokens. <span className="medium_bold">This works also for non-Blockchain projects (e.g AI, biotech, hardware etc.)</span> To demonstrate to the Blockchain community that our concept has practical potential, we have converted the 10% pool of Neufund stock reserved for the employees into Ethereum tokens, and have provided a smart contract to govern it in place of a legal agreement. Now any incorporated startup can use our solution to implement their ESOP on Blockchain.</p>
                    </div>
